        ...
        <div class="container">
            ...
            <div class="general__steps">
                <div class="general__steps-item">
                    ...
                    <div class="text">Разработка концептуального решения интерьера</div>
                </div>
                <div class="general__steps-item">
                    <div class="step">
                        <div class="second">
                    ...
                    <div class="text">Подготовка и составление мудбордов, коллажей и альбомов визуализаций</div>
                </div>
                <div class="general__steps-item">
                    <div class="step">
                        <div class="second">
                    ...
                    <div class="text">Проведение работ по декорированию интерьера в соответствии с концепцией</div>
                </div>
            </div>
