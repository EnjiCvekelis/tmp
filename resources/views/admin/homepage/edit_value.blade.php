...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.homepage.index')}}">Редактирование главной страницы</a>
            </li>
                ...
                <div class="card-body">
                    <form action="{{route('admin.values.update', [$value])}}" method="POST"
                        ...
                        <div class="form-group row border-bottom py-3">
                            <label for="valueHeadline" class="col-sm-2 col-form-label">Заголовок </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row border-bottom py-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" id="valueDescription"
                        ...
                        <div class="form-group row border-bottom py-3">
                            ...
                            <div class="image-upload-container" style="max-width:600px;">
                                <div class="image-edit">
                                    ...
                                    <label class="btn-image-upload"><span
                                                class="bi bi-card-image"></span></label>
                                </div>
                                <div class="image-preview-container"
                                     style="width: 300px; height: 150px; position: relative;">
                                    <div class="image-preview" data-init-image="/{{$value->icon}}">
                                    </div>
                                </div>
                            </div>
                        </div>
