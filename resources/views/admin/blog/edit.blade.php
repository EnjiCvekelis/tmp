    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.blog.update', [$post])}}" method="POST" class="form py-4"
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="form-group row border-bottom py-3">
                                    <label for="blogHeadline" class="col-sm-2 col-form-label">
                                        Заголовок</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="headline" id="blogHeadline" value="{{$post->headline}}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                ...
                                <textarea class="form-control" name="description" rows="5"
                                          id="blogDescription">{{$post->description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                ...
                                <div class="form-group row border-bottom py-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="source_name" id="sourceName" value="{{$post->source_name}}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="source_link" id="sourceLink" value="{{$post->source_link}}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    ...
                                    <div class="image-upload-container" style="max-width:600px;">
                                        ...
                                        <div class="image-preview-container"
                                            ...
                                            <div class="image-preview" data-init-image="{{assetImage($post->cover)}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="meta" role="tabpanel" aria-labelledby="meta-tab">
                                ...
                                <textarea type="text" class="form-control" name="meta_keywords" id="meta-keywords"
                                          rows="5">{{ $post->meta_keywords }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
