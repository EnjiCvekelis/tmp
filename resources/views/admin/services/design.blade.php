...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.services.design')}}">Редактирование страницы "Дизайн интерьеров"</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{isset($data) ? route('admin.services.design.update') : route('admin.services.design.create')}}" method="POST" class="form py-4"   enctype="multipart/form-data" >
                        @csrf
