...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.services.oversight')}}">Редактирование страницы "Авторский надзор"</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ isset($data) ? route('admin.services.oversight.update') : route('admin.services.oversight.create')}}" method="POST" class="form py-4"   enctype="multipart/form-data" >
                        @csrf
