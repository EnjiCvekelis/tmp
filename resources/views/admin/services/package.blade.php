...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.services.package')}}">Редактирование страницы "Комплектация"</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{isset($data) ? route('admin.services.package.update') : route('admin.services.package.create')}}" method="POST" class="form py-4"   enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="form-group row border-bottom py-3">
                                    ...
                                    <div class="image-upload-container" style="max-width:600px;">
                                        <div class="image-edit">
                                            <input class="image-upload" name="second_image" type='file'
                                                   accept=".png, .jpg, .jpeg, .gif, .svg"/>
                                            <label class="btn-image-upload"> <span class="bi bi-card-image"></span></label>
                                        </div>
                                        <div class="image-preview-container"
                                             style="width: 300px; height: 150px; position: relative;">
                                            <div class="image-preview" data-init-image="{{ isset($data) ? assetImage($data->second_image) : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row border-bottom py-3">
                                    <label for="third_subheadline" class="col-sm-2 col-form-label ">
                                        Подзаголовок
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="third_subheadline" id="third_subheadline"
                                               value="{{ isset($data) ? $data->third_subheadline : '' }}">
                                    </div>
                                </div>
                            </div>
