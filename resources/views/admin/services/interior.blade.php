...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="w-100">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.services.interior')}}">Редактирование страницы "Интерьерная живопись"</a></li>
        </ol>
    </nav>
    @if (count($errors) > 0)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{isset($data) ? route('admin.services.interior.update') : route('admin.services.interior.create')}}" method="POST" class="form py-4"   enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="form-group row border-bottom py-3">
                                    <label for="second_text" class="col-sm-2 col-form-label ">
                                        Текст
                                    </label>
                                    <div class="col-sm-10">
                                <textarea type="text" class="form-control" name="second_text" id="second_text"
                                          rows="5">{{ isset($data) ? $data->second_text : '' }}</textarea>
                                    </div>
                                </div>
                                <p class="h2">Третий блок</p>
                                <div class="form-group row border-bottom py-3">
                                    <label for="third_headline" class="col-sm-2 col-form-label ">
                                        Заголовок
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="third_headline" id="third_headline"
                                               value="{{ isset($data) ? $data->third_headline : '' }}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    <label for="third_text" class="col-sm-2 col-form-label ">
                                        Текст
                                    </label>
                                    <div class="col-sm-10">
                                <textarea type="text" class="form-control" name="third_text" id="third_text"
                                          rows="5">{{ isset($data) ? $data->third_text : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    <label class="col-sm-2 col-form-label">Изображение</label>
                                    <div class="image-upload-container" style="max-width:600px;">
                                        <div class="image-edit">
                                            <input class="image-upload" name="third_image" type='file'
                                                   accept=".png, .jpg, .jpeg, .gif, .svg"/>
                                            <label class="btn-image-upload"> <span class="bi bi-card-image"></span></label>
                                        </div>
                                        <div class="image-preview-container"
                                             style="width: 300px; height: 150px; position: relative;">
                                            <div class="image-preview" data-init-image="{{ isset($data) ? assetImage($data->third_image) : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <p class="h2">Четвертый блок</p>
                                <div class="form-group row border-bottom py-3">
                                    <label for="fourth_headline" class="col-sm-2 col-form-label ">
                                        Заголовок
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="fourth_headline" id="fourth_headline"
                                               value="{{ isset($data) ? $data->fourth_headline : '' }}">
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    <label for="fourth_text" class="col-sm-2 col-form-label ">
                                        Описание
                                    </label>
                                    <div class="col-sm-10">
                                <textarea type="text" class="form-control" name="fourth_text" id="fourth_text"
                                          rows="5">{{ isset($data) ? $data->fourth_text : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row border-bottom py-3">
                                    <label class="col-sm-2 col-form-label">Изображение</label>
                                    <div class="image-upload-container" style="max-width:600px;">
                                        <div class="image-edit">
                                            <input class="image-upload" name="fourth_image" type='file'
                                                   accept=".png, .jpg, .jpeg, .gif, .svg"/>
                                            <label class="btn-image-upload"> <span class="bi bi-card-image"></span></label>
                                        </div>
                                        <div class="image-preview-container"
                                             style="width: 300px; height: 150px; position: relative;">
                                            <div class="image-preview" data-init-image="{{ isset($data) ? assetImage($data->fourth_image) : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
