...
class InteriorPageUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'third_image' => "nullable|image|mimes:jpg,png,jpeg,gif,svg|max:2048",
            'fourth_headline' => "required|string|max:255",
            'fourth_text' => "required|string",
            'fourth_image' => "nullable|image|mimes:jpg,png,jpeg,gif,svg|max:2048",
